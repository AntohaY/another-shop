            ...
            <div class="row">
                <div class="col-md-3">
                    <ul style="list-style-type:none">
                        ...
                        <li><button class="btn" @click="setComponent('categories')">Categories</button></li>
                    </ul>
                </div>
                <div class="col-md-9">
...
<script>
    ...
    export default {
        ...
        beforeMount() {
            ...
            this.user = JSON.parse(localStorage.getItem('another-shop.  d fuser'))
            axios.defaults.headers.common['Content-Type'] = 'application/json'
            axios.defaults.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('another-shop.jwt')
        },
        methods: {
            setComponent(value) {
                switch(value) {
...
<style scoped>
    .hero-section { height: 20vh; background: #53ab47; align-items: center; margin-bottom: 20px; margin-top: -20px; }
