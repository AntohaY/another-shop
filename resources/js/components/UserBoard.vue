                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-4 product-box" v-for="(order,index) in orders" @key="index">
                            <img :src="order.product.image" :alt="order.product.name" style="width:250px;height:250px;">
...
<style scoped>
    ...
    .hero-section { background: #53ab47; height: 20vh; align-items: center; margin-bottom: 20px; margin-top: -20px; }
